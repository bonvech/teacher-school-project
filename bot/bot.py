...
def analyze_user_answer(question, user_answer):
    system_prompt = '''Ты - эксперт по анализу ответов пользователей. Твоя специализация педагогика, психология, конфликтология.
...
Добро пожаловать в ваш персональный тренажер педагогического мастерства! Здесь Вы сможете отработать решения сложных школьных ситуаций в безопасной среде и получить детальный разбор Вашей стратегии от искусственного интеллекта.    
